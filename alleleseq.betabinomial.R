##############################################################################
## alleleseq.betabinomial.R v2.0 by Jieming Chen
...
## (Rozowsky et al. 2011) 
## INPUT: 
## (1) counts.txt, output from AlleleSeq
## (2) b_chosen.grad.txt, output from calc.overdispersion.R
## (3) FDR threshold can be included as command line argument, 
##      default is 0.05 (no arguments):
##      R CMD BATCH "--args FDR.thresh=0.1" alleleseq.betabinomial.R
