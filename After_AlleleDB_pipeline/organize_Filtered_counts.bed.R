...
# combine multiple *Filtered_counts.bed into one SymCals files by "chrm" and "snppos"
...
file_list_c <- list.files(pattern=glob2rx("*Filtered_counts.bed"))
print (file_list_c)
